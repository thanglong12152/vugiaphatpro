            ...
            <div class="nav-tabs-custom">
               ...
               <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="settings">
                     <form class="form-horizontal" method="post" action="{{asset('admin/trademark/add')}}">
                        {{csrf_field()}}
                        <div class="form-group">
                           <label for="inputName" class="col-sm-2 control-label">Tên thương hiệu</label>
                           <div class="col-sm-5">
                              <input type="text" class="form-control" name="ten_thuong_hieu" id="ten_thuong_hieu" placeholder="Tên thương hiệu" required>
