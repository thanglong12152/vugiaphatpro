...
<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li class="active">THÊM TÍNH NĂNG SẢN PHẨM</li>
      </ol>
   </section>
   <!-- Main content -->
         ...
         <div class="col-md-12">
            <div class="nav-tabs-custom">
               <ul class="nav nav-tabs">
                  <li><a href="#settings" data-toggle="tab">THÊM TÍNH NĂNG SẢN PHẨM</a></li>
               </ul>
               <div class="tab-content">
                  ...
                  <div class="active tab-pane" id="settings">
                     <form class="form-horizontal" method="post" action="{{asset('admin/feature/add')}}">
                        {{csrf_field()}}
                        ...
                        <div class="form-group">
                           <label for="inputName" class="col-sm-2 control-label">Tính năng</label>
                           <div class="col-sm-5">
                              <input type="text" class="form-control" name="tinh_nang" id="tinh_nang" placeholder="Tính năng" required>
