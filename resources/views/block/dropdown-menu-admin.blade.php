            ...
            <ul class="sidebar-menu" data-widget="tree">
               ...
               <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                     ...
                     <li><a href="{{asset('admin/productType/all')}}"><i class="far fa-circle"></i>Danh sách loại sản
                           phẩm</a></li>
                     <li><a href="{{asset('admin/productType/add')}}"><i class="far fa-circle"></i>Thêm loại sản
                           phẩm</a></li>
                  </ul>
               </li>
               <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                     ...
                     <li><a href="{{asset('admin/trademark/add')}}"><i class="far fa-circle"></i>Thêm thương hiệu</a>
                     </li>
