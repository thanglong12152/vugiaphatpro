                                    ...
                                    <div id="kich_thuoc" class="field_label filters_in_field filters_in_field_2_column filter_4_kich_thuoc">
                                       <div class="filters_in_field_inner cls">
                                          ...
                                          @foreach($kich_thuoc as $data)
                                           <div class="cls item"><a href="#" title="{{$data->kich_thuoc}}"><i class="icon_v1 "></i>{{$data->kich_thuoc}}</a></div>
                                          @endforeach
                                       </div>
                                    </div>
                                 </div>
            ...
            <div class="products-cat-frame-inner descriptions">
               <article class="cat_summary cls">
                  ...
                  <div class="summary_content">
                     <p><strong>Bồn tắm, bồn tắm massage, bồn tắm đứng, nằm góc&nbsp;</strong>cao cấp tại Vũ Gia Phát được lựa chọn từ các thương hiệu hàng đầu Châu Âu và Việt Nam. Tất cả các sản phẩm <strong>Bồn tắm</strong> tại Vũ Gia Phát cung cấp trước khi xuất xưởng đã trải qua các công đoạn&nbsp;thử nghiệm về chất lượng và độ bền bằng những máy móc, thiết bị&nbsp;tiên tiến nhất dưới bàn tay của những kỹ sư hàng đầu.</p>
                     <p><strong>Thương hiệu:</strong> Tại <strong>Vũ Gia Phát</strong> cung cấp các thương hiệu nhập khẩu hàng đầu như <strong>Nofer, Euroking, Daros, Kawa, Sara</strong> và các thương hiệu sản xuất tại Việt Nam có thương hiệu lớn như <strong>Amazon, Euroca, Milano, Fantiny</strong> ... vv Cam kết mang tới tay khách hàng sản phẩm chất lượng kèm dịch vụ hỗ trợ vận chuyển và lắp đặt miễn phí tại Hà Nội và Hồ Chí Minh.</p>
                     <p><strong>Chế độ bảo hành :</strong>&nbsp;Tất cả các sản phẩm bồn tắm nằm được bảo hành từ 2 đến 5 năm&nbsp;tại nhà tuỳ vào từng thương hiệu&nbsp;trên toàn bộ hệ thống siêu thị Vũ Gia Phát. Chúng tôi là đại lý phân phối bồn tắm nằm&nbsp;chính hãng tại Việt Nam. Chúng tôi cam kết về chất lượng và giá là tốt nhất.</p>
                  </div>
               </article>
