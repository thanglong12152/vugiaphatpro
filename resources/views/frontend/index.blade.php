         ...
         <div class="wapper-content-page">
            <div class="cat_item_store" id="cat_item_store_2">
               <div class="cat-title cls">
                  ...
                  <ul class="nav nav-tabs pull-left">
                     <li class="item_tabs view_all"><a href="{{url('/bon-tam')}}" title="Xem thêm Bồn tắm">Xem tất cả
                           <span>››</span></a></li>
                  </ul>
               </div>
            ...
            <div class="cat_item_store" id="cat_item_store_3">
               <div class="cat-title cls">
                  ...
                  <ul class="nav nav-tabs pull-left">
                     <li class="item_tabs view_all"><a href="{{url('/phong-xong-hoi')}}"
                     ...
                     <div class="item">
                        <div class="frame_inner">
                           ...
                           <h3><a href="https://vugiaphat.vn/bon-tam-nam/von-tam-nam-amazon-tp-7002-p1429.html"
                                 title="Bồn tắm nằm Amazon TP-7002" class="name">{{$data->ten_sp}}</a>
                           </h3>
                           <div class="discount"><span>-{{100-ceil(($data->sale_price/ $data->gia_goc)*100)}}%</span>
                           </div>
                           <div class="price_arae">
            ...
            <div class="cat_item_store" id="cat_item_store_4">
               <div class="cat-title cls">
                  ...
                  <ul class="nav nav-tabs pull-left">
                     <li class="item_tabs view_all"><a href="{{url('/may-xong-hoi')}}" title="Xem thêm Máy xông hơi">Xem
            ...
            <div class="cat_item_store" id="cat_item_store_23">
               <div class="cat-title cls">
                  ...
                  <ul class="nav nav-tabs pull-left">
                     <li class="item_tabs view_all"><a href="{{url('/thiet-bi-ve-sinh')}}"
