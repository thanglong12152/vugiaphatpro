...
<div class="main_wrapper container">
   <div class="main-area main-area-1col main-area-full">
      ...
      <div class="banner_cat cls">
         <figure><a href="https://vugiaphat.vn/phong-xong-hoi-kho/thiet-ke-phong-xong-hoi-kho-1mx1m5x2m-p264.html"
               title="Thiết kế phòng xông hơi gia đình"><img
                  src="https://vugiaphat.vn/images/products/cat/resized/banner-phong-xong-hoi_1556277632.jpg"
                  alt="Phòng xông hơi"></a></figure>
         <figure><a href="https://vugiaphat.vn/phong-xong-hoi-kho/thiet-ke-phong-xong-hoi-kho-1mx1mx2m-p279.html"
               title="Phòng xông hơi khô 1m x 1m x 2m "><img
                  src="https://vugiaphat.vn/images/products/cat/resized/pxh-kho_1556277632.jpg"
                  alt="Phòng xông hơi"></a></figure>
      </div>
                                 ...
                                 <div class="field_area field_item" id="m-kich_thuoc">
                                    ...
                                    <div id="kich_thuoc"
                                       ...
                                       <div class="filters_in_field_inner cls">
                                          ...
                                          <div class="cls item"><a href="#" title="<?php echo e($data->kich_thuoc); ?>"><i
                                                   class="icon_v1 "></i><?php echo e($data->kich_thuoc); ?></a></div>
         ...
         <section class="products-cat-frame">
            <div class="products-cat-frame-inner description">
               <div class="product_grid">
                  ...
                  <?php else: ?>
                  <?php $__currentLoopData = $product['Items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php
                  ...
                  <div class="item" itemscope="" itemtype="http://schema.org/Product">
                     <div class="frame_inner">
                        <link itemprop="url" href="<?php echo e(url('chi-tiet-san-pham/'.$data->slug_sp)); ?>">
                        <figure class="product_image ">
                           <a href="<?php echo e(url('chi-tiet-san-pham/'.$data->slug_sp)); ?>" title="Bồn tắm nằm Amazon TP-7002"
                           ...
                           <div class="button_area"><a href="javascript:void(0)" onclick="add_cart(1429,1)"
                                 class="add_cart"><i></i></a><a href="<?php echo e(url('chi-tiet-san-pham/'.$data->slug_sp)); ?>"
                                 class="detail_button" title="Chi tiết sản phẩm"><i></i></a></div>
                        </figure>
                        <h2 itemprop="name"><a href="<?php echo e(url('chi-tiet-san-pham/'.$data->slug_sp)); ?>"
