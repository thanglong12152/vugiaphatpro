         ...
         <div class="row footer-2">
            <div class="footer_left">
                     ...
                     <ul class="row menu-bottom">
                        ...
                        <li class="level0 menu-item collapse1">
                           <div class="collape_1">
                              <div class="row">
                                 ...
                                 <span class="btn" data-toggle="collapse" data-target="#answers7"><i class="fas fa-plus"
                           ...
                           <div class="collape_1">
                              <div class="row">
                                 <h4>Về chúng tôi</h4>
                                 <span class="btn" data-toggle="collapse" data-target="#answers1"><i class="fas fa-plus"
                                       style="color:#b3b3b3;font-size: 13px;"></i></span>
                              </div>
                        ...
                        <li class="level0 menu-item network">
                           ...
                           <a href="https://www.facebook.com/noithatvugiaphat"><img class="icon-nw"
                                 src="<?php echo e(asset('image/facebook.png')); ?>"></a>
                           <a href="https://zalo.me/0916680110"><img class="icon-nw"
                                 src="<?php echo e(asset('image/zalo.png')); ?>"></a>
                           <a href="https://www.youtube.com/channel/UCD15F4BRLqarmyKcWrn1Apg"><img class="icon-nw"
                                 src="<?php echo e(asset('image/youtube.png')); ?>"></a>
                        </li>
                     </ul>
                  </div>
               </div>
               <div class="tags block_content">
                  ...
                  <a href="https://vugiaphat.vn/thiet-bi-bep-pc33.html" title="Thiết bị nhà bếp" class=" tag_item">Thiết
                     bị nhà bếp</a>,
                  <a href="http://vugiaphat.vn/phong-xong-hoi-pc3.html" title="Phòng xông hơi" class=" tag_item">Phòng
                     xông hơi</a>,
                  <a href="http://vugiaphat.vn/bon-tam-pc2.html" title="Bồn tắm" class=" tag_item">Bồn
                     tắm</a>,
                  <a href="http://vugiaphat.vn/may-xong-hoi-pc4.html" title="Máy xông hơi" class=" tag_item">Máy xông
                     hơi</a>,
                  <a href="https://vugiaphat.vn/bon-cau-bet-pc25.html" title="Bồn cầu - bệt" class=" tag_item">Bồn cầu -
                     bệt</a>,
                  <a href="https://vugiaphat.vn/sen-tam-nong-lanh-pc24.html" title="Sen tắm" class=" tag_item">Sen
                     tắm</a>
               </div>
            </div>
            <div class="footer_r level2">
               ...
               <script async defer crossorigin="anonymous"
                  src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v5.0&appId=479519062835494&autoLogAppEvents=1">
               </script>
      ...
      <div class="container cls">
         <div class="row">
            ...
            <div class="footer_r fl"><img class="lazy" alt="Đã thông báo" title="Đã thông báo"
                  src="https://vugiaphat.vn/images/config/untitled-2_1556271223.png" style="display: inline-block;">
            </div>
         </div>
      </div>
   </div>
...
<script src="https://use.fontawesome.com/e8cf6f9ff5.js"></script>
</html><?php /**PATH C:\xampp\htdocs\vugiaphatpro\resources\views/block/footer.blade.php ENDPATH**/ ?>