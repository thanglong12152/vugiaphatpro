   ...
   <body class="hold-transition skin-blue sidebar-mini">
      <div class="wrapper">
         <header class="main-header">
            <!-- Logo -->
            <a href="<?php echo e(asset('admin')); ?>" class="logo">
                     ...
                     <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li class="user-footer">
                              ...
                              <a href="<?php echo e(asset('admin/logout')); ?>" class="btn btn-default btn-flat">Sign out</a>
                              </div>
                           </li>
                        </ul>
                     </li>
         ...
         <aside class="main-sidebar">
                     ...
                     <li class="header">MAIN NAVIGATION</li>
                           ...
                           <li class="treeview">
                                 ...
                                 <ul class="treeview-menu">
                                    <li><a href="<?php echo e(asset('admin/product/all')); ?>"><i class="far fa-circle"></i>Xem danh sách</a></li>
                                    <li><a href="<?php echo e(asset('admin/product/add')); ?>"><i class="far fa-circle"></i>Thêm sản phẩm</a></li>
                                    <li><a href="<?php echo e(asset('admin/productType/all')); ?>"><i class="far fa-circle"></i>Danh sách loại sản phẩm</a></li>
                                    <li><a href="<?php echo e(asset('admin/productType/add')); ?>"><i class="far fa-circle"></i>Thêm loại sản phẩm</a></li>
                                 </ul>
                              </li>
                              <li class="treeview">
                                 <a href="">
                                 ...
                                 <ul class="treeview-menu">
                                    <li><a href="<?php echo e(asset('admin/trademark/all')); ?>"><i class="far fa-circle"></i>Xem danh sách</a></li>
                                    <li><a href="<?php echo e(asset('admin/trademark/add')); ?>"><i class="far fa-circle"></i>Thêm thương hiệu</a></li>
                              ...
                              <li class="treeview">
                                 ...
                                 <ul class="treeview-menu">
                                    <li><a href="<?php echo e(asset('admin/feature/all')); ?>"><i class="far fa-circle"></i>Xem danh sách</a></li>
                                    <li><a href="<?php echo e(asset('admin/feature/add')); ?>"><i class="far fa-circle"></i>Thêm tính năng</a></li>
            ...
            <!-- /.sidebar -->
         </aside><?php /**PATH C:\xampp\htdocs\vugiaphatpro\resources\views/block/dropdown-menu-admin.blade.php ENDPATH**/ ?>