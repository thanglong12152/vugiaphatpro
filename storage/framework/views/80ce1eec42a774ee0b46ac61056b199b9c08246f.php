...
<body>
         ...
         <div class="header_wrapper">
            <div class="header clr" id="header_inner">
               <div class="header-1">
                  ...
                  <h1>
                     <a href="http://localhost:8010/" title="Vũ Gia Phát - Thiết bị phòng tắm, phòng bếp nhập khẩu"
                        class="logo" rel="home">
                        <img class="logo_img"
               ...
               <div class="mainmenu_wrapper" id="menu-fixed-bar">
                  ...
                  <ul class="mainmanu cls">
                     <li class="level_0 " id="menu-bon-tam">
                        <a href="http://localhost:8010/bon-tam" title="Bồn tắm">
                     ...
                     <li class="level_0 " id="menu-bon-tam">
                        <a href="http://localhost:8010/phong-xong-hoi" title="Phòng xông hơi">
                           <span class="icon_svg cls">
                     ...
                     <li class="level_0 " id="menu-bon-tam">
                        <a href="http://localhost:8010/may-xong-hoi" title="Máy xông hơi">
                           <span class="icon_svg cls">
                     ...
                     <li class="level_0 " id="menu-bon-tam">
                        <a href="http://localhost:8010/quat-den-tran" title="Quạt đèn trần">
                           <span class="icon_svg cls">
                     ...
                     <li class="level_0 " id="menu-bon-tam">
                        <a href="http://localhost:8010/tin-tuc" title="Tin tức">
                           <span class="icon_svg cls">
                     ...
                     <li class="level_0 " id="menu-dang-nhap">
                        <a href="http://localhost:8010/logout" title="Đăng xuất">
                           <span class="icon_svg cls">
                              <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                 ...
                                 <g>
                                    <g>
                                       <g>
                                          <path
                                             d="M320.044,55.872c0.619,5.867,4.971,8.619,7.552,10.261c4.309,2.731,14.4,9.131,14.4,40.533v64.021
                                         ...
                                         c0-34.795,33.259-85.333,85.333-85.333c49.536,0,62.336,21.931,63.829,30.379C320.086,53.163,319.894,54.613,320.044,55.872z" />
                                          <path
                                             d="M500.673,362.219h-10.667v-10.667c0-41.173-33.493-74.667-74.667-74.667s-74.667,33.493-74.667,74.667v10.667h-10.667
                           ...
                           <span class="visible-xs visible-sm ">Đăng xuất</span>
                        </a>
                        <span class="mb_arrow closed"></span>
                     </li>
                     <?php else: ?>
                     <li class="level_0 " id="menu-dang-nhap">
                        <a href="http://localhost:8010/login" title="Đăng nhập">
                           <span class="icon_svg cls">
                              <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512"
                                 style="enable-background:new 0 0 512 512;" xml:space="preserve">
   ...
   </header><?php /**PATH C:\xampp\htdocs\vugiaphatpro\resources\views/block/header.blade.php ENDPATH**/ ?>