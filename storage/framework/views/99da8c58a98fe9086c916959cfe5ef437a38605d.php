               ...
               <div class="item item_1">
                  <div class="item-inner">
                     ...
                     <div class="item-r">
                        ...
                        <a href="" title="Chính sách hỗ trợ"> <span class="summary">Giảm 50% phí vận chuyển
                              ngoại tỉnh</span></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="item item_2">
                  <div class="item-inner">
                     ...
                     <div class="item-r">
                        ...
                        <a href="" title="Giá cạnh tranh"> <span class="summary">Cạnh tranh, chi phí phát
                              sinh thấp</span></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="item item_3">
                  <div class="item-inner">
                     ...
                     <div class="item-r">
                        ...
                        <a href="" title="Miễn phí khảo sát"> <span class="summary">Tư vấn khảo sát tại nhà
                     ...
                     <div class="item-l">
                        <div class="isvg">
                           <a href="" title="Bảo hành vượt trội">
                              <svg viewBox="0 0 297 297" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <div class="slideshow-hot-list products_blocks_slideshow_hot">
               <div class="item ">
                  <div class="frame_inner cls">
                     ...
                     <figure class="product_image " style="min-width: 100px;">&nbsp;<a
                           ...
                           title="Máy xông hơi ướt Amazon TPA-45"><img class="abt" alt="Máy xông hơi ướt Amazon TPA-45"
               ...
               <div class="item ">
                  <div class="frame_inner cls">
                     ...
                     <div class="des">
                        <h2><a href="https://vugiaphat.vn/may-xong-uot/may-xong-hoi-uot-amazon-tpa-45-p267.html"
                              title="Máy xông hơi ướt Amazon TPA-45" class="name">Thiết kế phòng xông hơi khô
                              1mx1mx2m<br><span class="sumhotdeal">(Sản Xuất Tại Việt Nam)</span></a>
                        </h2>
                        <div class="price_arae">
                           <div class="title_gia">Giá<br>chỉ</div>
               ...
               <div class="item ">
                  <div class="frame_inner cls">
                     ...
                     <figure class="product_image " style="min-width: 100px;">&nbsp;<a
                           ...
                           title="Bồn tắm đứng Appollo Super 3"><img class="abt" alt="Bồn tắm đứng Appollo Super 3"
            ...
            <div class="cat_item_store" id="cat_item_store_2">
               <div class="cat-title cls">
                  ...
                  <ul class="nav nav-tabs pull-left">
                     <li class="item_tabs view_all"><a href="<?php echo e(url('/bon-tam')); ?>" title="Xem thêm Bồn tắm">Xem tất cả
                           <span>››</span></a></li>
                  </ul>
               </div>
               <div class="product_grid">
                  <div class="row_inner" id="box_product_2">
                     <!--	EACH PRODUCT	-->
                     <?php $__currentLoopData = $product_Bath['Items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                     <?php
                     ...
                     <div class="item">
                        <div class="frame_inner">
                           ...
                           href="<?php echo e(url('/chi-tiet-san-pham/'.$data->slug_sp)); ?>"
                                 title="<?php echo e($data->ten_sp); ?>"> <img alt="<?php echo e($data->ten_sp); ?>" class="lazy"
                                    src="<?php echo e(url('image/product/small/'.$data->anh_sp)); ?>" style="display: inline-block;">
                              </a> </figure>
                           <h3><a href="<?php echo e(url('/chi-tiet-san-pham/'.$data->slug_sp)); ?>"
                                 title="<?php echo e($data->ten_sp); ?>" class="name"><?php echo e($data->ten_sp); ?></a>
                           </h3>
                           <div class="discount"><span>-<?php echo e(100-ceil(($data->sale_price/ $data->gia_goc)*100)); ?>%</span>
                           </div>
                           <div class="price_arae">
            ...
            <div class="cat_item_store" id="cat_item_store_3">
               <div class="cat-title cls">
                  <h2 class="cat-title-main cat-3" id="cat-phong-xong-hoi">
                     ...
                     <a href="https://vugiaphat.vn/phong-xong-hoi-pc3.html" title="Phòng xông hơi">Phòng xông hơi</a>
                  </h2>
                  <ul class="nav nav-tabs pull-left">
               ...
               <div class="product_grid">
                  <div class="row_inner" id="box_product_3">
                     <!--	EACH PRODUCT	-->
                     <?php $__currentLoopData = $product_sauna['Items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                     <?php
                     ...
                     <div class="item">
                        <div class="frame_inner">
                           <figure class="product_image "> <a
                                 ...
                                 title="Bồn tắm nằm Amazon TP-7002"> <img alt="Bồn tắm nằm Amazon TP-7002" class="lazy"
                                    src="<?php echo e(url('image/product/small/'.$data->anh_sp)); ?>" style="display: inline-block;">
                              </a> </figure>
            ...
            <div class="cat_item_store" id="cat_item_store_4">
               <div class="cat-title cls">
                  <h2 class="cat-title-main cat-4" id="cat-may-xong-hoi">
                     ...
                     <a href="https://vugiaphat.vn/may-xong-hoi-pc4.html" title="Máy xông hơi">Máy xông hơi</a>
                  </h2>
                  <ul class="nav nav-tabs pull-left">
                     <li class="item_tabs view_all"><a href="<?php echo e(url('/may-xong-hoi')); ?>" title="Xem thêm Máy xông hơi">Xem
                           tất cả <span>››</span></a></li>
                  </ul>
               </div>
               <div class="product_grid">
                  <div class="row_inner" id="box_product_4">
                     <!--	EACH PRODUCT	-->
                     <?php $__currentLoopData = $product_steam['Items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                     <?php
            ...
            <div class="cat_item_store" id="cat_item_store_23">
               <div class="cat-title cls">
                  <h2 class="cat-title-main cat-23" id="cat-thiet-bi-ve-sinh">
                     ...
                     <a href="https://vugiaphat.vn/thiet-bi-ve-sinh-pc23.html" title="Thiết bị vệ sinh">Thiết bị vệ
                        sinh</a>
                  </h2>
                  <ul class="nav nav-tabs pull-left">
               ...
               <div class="product_grid">
                  <div class="row_inner" id="box_product_23">
                     <!--	EACH PRODUCT	-->
                     <?php $__currentLoopData = $product_tbvs['Items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                     <?php
         ...
         <div class="container">
            <div class="block_videos videos-_video_list videos_0 block" id="block_id_110">
               <div class="block_title">
                  <div class="title_icon">
                     <svg x="0px" y="0px" viewBox="0 0 41.999 41.999" style="enable-background:new 0 0 41.999 41.999;"
                        xml:space="preserve">
                        <path
                        ...
                        <div class="video_item_inner video_item_inner_has_img">
                           ...
                           <div class="play-icon">
                              <span class="play-video">
                                 <svg x="0px" y="0px" viewBox="0 0 60 60" style="enable-background:new 0 0 60 60;"
                                    xml:space="preserve">
                                    <g>
                                       <path
                     ...
                     <div class="slideproject">
                        <div class="" id="slideshow_slider">
                           <div class="item">
                              <div class="item-inner">
                                 <div class="image"><a
                                       href="https://vugiaphat.vn/lap-dat-phong-xong-hoi/thi-cong-phong-xong-hoi-da-muoi-hang-tho-dat-set-bi-quan-1-dpj146.html"
                                       title="Thi công phòng xông hơi đá muối hàng thổ đất Sét Bi Quận 1"
                                       tabindex="-1"><img
                                          alt="Thi công phòng xông hơi đá muối hàng thổ đất Sét Bi Quận 1" class=""
                                          src="https://vugiaphat.vn/images/projects/2019/05/18/large/ban-ve-3d5_1558155794.jpg"
                                 ...
                                 <div class="item-r">
                                    <div class="innerr">
                                       <div class="name"><a
                                             href="https://vugiaphat.vn/lap-dat-phong-xong-hoi/thi-cong-phong-xong-hoi-da-muoi-hang-tho-dat-set-bi-quan-1-dpj146.html"
                                             title="Thi công phòng xông hơi đá muối hàng thổ đất Sét Bi Quận 1"
                                             tabindex="-1">Thi công phòng xông hơi đá muối hàng thổ đất Sét Bi Quận
                                             1</a></div>
                                       <div class="read_more"><a
                                             href="https://vugiaphat.vn/lap-dat-phong-xong-hoi/thi-cong-phong-xong-hoi-da-muoi-hang-tho-dat-set-bi-quan-1-dpj146.html"
                                             title="Thi công phòng xông hơi đá muối hàng thổ đất Sét Bi Quận 1"
                                             tabindex="-1">Xem thêm</a></div>
                                    </div>
                                 </div>
                              </div>
                           </div>
               ...
               <div class="block_content">
                  <div class="news_list_body newslist_list_slideshow cls">
                     <div class="item">
                        ...
                        <div class="summary">Bạn đang có nhu cầu muốn xây dựng hồ bơi, bể bơi cho gia đình khu biệt thự
                           hay xây dựng hồ bơi để...</div>
                     </div>
                     <div class="item">
                        <figure class="new_image">
                           <a href="https://vugiaphat.vn/bao-gia/thiet-ke-thi-cong-ho-boi-n42.html"
