             ...
             <div class="slideshow-hot-list products_blocks_slideshow_hot">
                ...
                <div class="item ">
                  <div class="frame_inner cls">
                     ...
                     <div class="des">
                        <h2><a href="https://vugiaphat.vn/may-xong-uot/may-xong-hoi-uot-amazon-tpa-45-p267.html"
                           title="Máy xông hơi ướt Amazon TPA-45" class="name">Thiết kế phòng xông hơi khô 1mx1mx2m<br><span class="sumhotdeal">(Sản Xuất Tại Việt Nam)</span></a>
                        </h2>
                        <div class="price_arae">
                           <div class="title_gia">Giá<br>chỉ</div>
             ...
             <div class="cat_item_store" id="cat_item_store_2">
                ...
                <div class="product_grid">
                   <div class="row_inner" id="box_product_2">
                      <!--	EACH PRODUCT	-->
                      <?php $__currentLoopData = $product_Bath; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="item">
             ...
             <div class="cat_item_store" id="cat_item_store_3">
                ...
                <div class="product_grid">
                   <div class="row_inner" id="box_product_3">
                      <!--	EACH PRODUCT	-->
                      <?php $__currentLoopData = $product_sauna; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
